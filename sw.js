const CACHE_NAME = 'move-strong-rehab-v3.1.0';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=3.1.0',
  './app.js?v=3.1.0',
  './health-model.js?v=3.1.0',
  './exercise-instructions.js?v=3.1.0',
  './cloud-sync.js?v=3.1.0',
  './health-os.js?v=3.1.0',
  './navigation.js?v=3.1.0',
  './push-client.js?v=3.1.0',
  './health-os.css?v=3.1.0',
